...
test('Phase 5.2 Design Tokens: theme.css defines dark default & light tokens, tabular-nums, focus-ring, and reduced-motion', () => {
  ...
  assert.match(content, /--color-canvas:\s*#(?:08090a|090D16|0F172A)/i)
  assert.match(content, /--color-surface-base:\s*#(?:121417|0F172A|16233A|FFFFFF)/i)
  assert.match(content, /--color-accent:\s*#(?:6366f1|3B82F6|2DD4BF|0F766E)/i)
  assert.match(content, /--color-status-success:\s*#(?:10B981|34D399|047857|059669)/i)
  assert.match(content, /--color-status-warning:\s*#(?:F59E0B|D97706)/i)
  assert.match(content, /--color-status-danger:\s*#(?:EF4444|DC2626)/i)
  assert.match(content, /--color-status-info:\s*#(?:06B6D4|22D3EE|0891B2|0F766E)/i)
